...
<header class="header-area header-sticky">
      ...
      <div class="col-lg-12">
        <div class="page-content">
            ...
            <div class="col-lg-8">
              <div class="featured-games header-text">
                <div class="heading-section">
                  <h4><em>Featured</em> StuffedToys</h4>
                </div>
                <div class="owl-features owl-carousel">
                  <div class="item">
                    ...
                    <h4>VERMONT TEDDY BEAR COMPANY<br><span>450K ORDERS</span></h4>
                    <ul>
                  ...
                  <div class="item">
                    ...
                    <h4>BEDTIME ORIGINALS<br><span>300K ORDERS</span></h4>
                    <ul>
                      <li><i class="fa fa-star"></i> 4.8</li>
                    </ul>
                  </div>
                  <div class="item">
                    ...
                    <h4>MORISMOS<br><span>249K ORDERS</span></h4>
                    <ul>
                      <li><i class="fa fa-star"></i> 4.8</li>
                    </ul>
                  </div>
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="item">
                    ...
                    <h4>Contact Us</h4>
                    <p>Email: johnlloydsagrado1@gmail.com</p>
                    <p>Contact Number: 09656590846</p>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="item">
                    ...
                    <h4>Talk with us</h4>
                    <p>If you wish to order dont hesitate to talk with us.</p>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="item">
                    ...
                    <h4>Set your Order</h4>
                    <p>You are allowed to set what you want to deliver your Orders</p>
                  </div>
                </div>
                <div class="col-lg-12">
          ...
          <div class="live-stream">
            <div class="col-lg-12">
              <div class="heading-section">
                <h4><em>Most Popular</em> Sellers</h4>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-3 col-sm-6">
                <div class="item">
                  <div class="thumb">
                    ...
                    <div class="hover-effect">
                      <div class="content">
                        ...
                        <ul>
                          <li><a href="#"><i class="fa fa-eye"></i> Follow</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div class="down-content">
                    ...
                    <span><i class="fa fa-check"></i> Jollyver Sujetado Piscos</span>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="item">
                  ...
                  <div class="down-content">
                    ...
                    <span><i class="fa fa-check"></i> Christ Niuman Fantonial</span>
                    <h4>Only Fans</h4>
                  </div> 
                </div>
              </div>
              <div class="col-lg-3 col-sm-6">
                <div class="item">
                  ...
                  <div class="down-content">
                    ...
                    <span><i class="fa fa-check"></i> Ivy Grace Mapalad</span>
                    <h4>Maybe Chillin'</h4>
                  </div> 
                </div>
              </div>
              <div class="col-lg-3 col-sm-6">
                <div class="item">
                  ...
                  <div class="down-content">
                    ...
                    <span><i class="fa fa-check"></i> Loren Pacuribot</span>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2023 <a href="#">Stuffed Toys</a> Company. All rights reserved. 
        </div>
      </div>
    </div>
  </footer>
